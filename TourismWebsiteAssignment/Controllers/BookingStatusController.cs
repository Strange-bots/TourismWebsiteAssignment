...
namespace TourismWebsiteAssignment.Controllers
{
    public class BookingStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingStatusId,StatusName,Description")] BookingStatus bookingStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookingStatusId,StatusName,Description")] BookingStatus bookingStatus)
        {
            if (ModelState.IsValid)
            {
